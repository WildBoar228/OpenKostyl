...
import io, pygame, lib.openmv.rpc as rpc, serial, serial.tools.list_ports, socket, sys, time, ctypes
...
def threshold_diff(thr1, rect, pixels):
    ...
    print(thr1, end=' -> ')
    result = noise_lib.remove_noise(colorspace, thr, 1)
